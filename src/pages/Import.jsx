...
const BROKERS = ['NinjaTrader', 'Tradovate', 'MT5 Toolbox', 'MT5 MQL5', 'MNQ Logger', 'Custom']
...
const BROKER_DESCRIPTIONS = {
  ...
  Custom:        'Clean format: Date, PnL, Session, Outcome, R Value, Notes',
}
