...
const INSTRUMENTS = ['MNQ', 'NQ', 'MES', 'ES', 'Other']
...
export default function AddTradeModal({ onClose, prefillDate }) {
  ...
  const [form, setForm] = useState({ ...EMPTY, date: prefillDate || today })
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input
                ...
                className={`input font-mono ${form.pnl !== '' && !isNaN(form.pnl)
                  ? Number(form.pnl) >= 0 ? 'text-emerald-400' : 'text-red-400'
                  : ''}`}
                autoFocus
                required
              />
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Trade setup, mistakes, lessons..."
              rows={2}
